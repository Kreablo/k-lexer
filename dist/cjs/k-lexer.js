...
exports.KLexer = exports.KLexerContext = void 0;
...
class KLexerContext {
    ...
    match(input, index, rowBegin, columnBegin) {
        ...
        if (match === this.tokenGenerators.length + 1) {
            ...
            throw new typescript_parsec_1.TokenError({ index, rowBegin, columnBegin, rowEnd: rowBegin, columnEnd: columnBegin }, this.errormessage);
        }
...
exports.KLexerContext = KLexerContext;
class KLexer {
